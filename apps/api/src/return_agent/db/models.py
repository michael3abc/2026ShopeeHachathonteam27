...
class OperationalMemoryRecord(Base):
    ...
    source_event_refs: Mapped[list[str]] = mapped_column(JSON, nullable=False)
    applicability_limits: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
    prohibited_inferences: Mapped[list[str]] = mapped_column(JSON, nullable=False, default=list)
    policy_version: Mapped[str] = mapped_column(String(256), nullable=False)
