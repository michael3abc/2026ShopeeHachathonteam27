...
export const graphNodes = [
  ...
  { node: "evaluate_policy", lane: "main" },
  { node: "confirm_policy_path", lane: "loop" },
...
export const graphEdges = [
  ...
  { from: "assess_case", to: "evaluate_policy", kind: "forward" },
  { from: "evaluate_policy", to: "propose_decision", kind: "forward" },
  { from: "evaluate_policy", to: "confirm_policy_path", kind: "forward" },
  { from: "propose_decision", to: "confirm_policy_path", kind: "loop" },
  { from: "confirm_policy_path", to: "retrieve_policy", kind: "loop" },
  { from: "confirm_policy_path", to: "request_evidence", kind: "loop" },
  { from: "evaluate_policy", to: "request_evidence", kind: "loop" },
